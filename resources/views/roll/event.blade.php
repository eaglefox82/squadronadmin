            ...
            <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <!--  <div class="pull-right new-button">
                    ...
                    <button class="btn btn-round btn-primary pull-right" data-toggle="modal" data-target="#newrollModal"><i class="fa fa-plus fa-2x"></i>New Event</button>
                    <a href="{{action('RollController@parade')}}" class="btn btn-round btn-info pull-right"><i class="fa fa-book fa-2x"></i>Event Roll</a>
                </div>
                <div class="card-body">
