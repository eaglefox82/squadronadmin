<html>
    ...
    <body>
        ...
        <small style="text-align: center">This report was generated on {{date("l - jS F Y",strtotime($reportdate))}} at {{date("g:i a")}}</small><br>
        <small> Report generated by {{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</small>
        <small>Run on behalf of  {{ config('app.name', 'Squadron') }} Sqaudron</small>
    </body>
</html>
